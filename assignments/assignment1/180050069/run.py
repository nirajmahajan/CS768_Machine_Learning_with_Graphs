...
parser.add_argument('--dump_pickle', action = 'store_true')
parser.add_argument('--test_fraction', type = float, default = 0.2)
parser.add_argument('--data', type = str, default = './datasets/facebook.txt')
...
test_fraction_mapping[0.3] = 0.31
...
if just_LR:
	...
	if args.load_pickle:
		...
		lr_instance = myLogisticRegression(gtrain_validate, test_fraction_mapping2, test_edges_nonedges, num_train_sets = 1, load_pickle = args.load_pickle, dump_pickle = args.dump_pickle)
		lr_instance.train()
